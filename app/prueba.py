...
empr = modelo_empresa.objects.create(empresa="tios",longitud="-25.283612",latitud="-57.499013")
...
s = empresaSerializer(instance=empr)
empr = modelo_empresa.objects.create(empresa="tioasds",longitud="-25.276589",latitud="-57.485495")
...
modelo_producto.objects.create(empresa=empr,producto="item33.1",precio=14000)
s = empresaSerializer(instance=empr)
